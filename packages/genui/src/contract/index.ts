...
/**
 * Host-owned context that belongs to the surrounding assistant message rather
 * than to the model-authored widget payload. Keeping citations here prevents a
 * widget from forging or duplicating message sources in its own props.
 */
export interface WidgetCitationSource {
  id: string;
