...
import { ChevronDownSmall } from "@/components/ui/chevrons";
import { cx } from "@/utils/cx";
import { useDismissOnOutsidePress, useTriggerToggle } from "@/utils/use-dismiss-on-outside-press";

/**
 * Product select trigger and listbox behavior.
 ...
 *
 * The open popover/listbox shares the Web menu recipe with Dropdown:
