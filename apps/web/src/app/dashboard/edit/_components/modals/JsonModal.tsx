            ...
            {isJsonModalOpen && (
                <>
                    ...
                    <div className="fixed inset-0 z-101 flex items-center justify-center p-4 pointer-events-none">
                        ...
                        <div className="flex items-center justify-between px-6 py-4">
                            <div className="flex items-center gap-3">
                                <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-sky-400/10 text-sky-400 ring-1 ring-sky-400/20">
                                    <span className="font-mono text-mr-micro font-bold tracking-tight">{t('common.ui.json')}</span>
                                </div>
                                <h2 className="text-mr-subtitle font-semibold tracking-tight text-white">{t('mobileEdit.jsonData')}</h2>
                            </div>
                            <div className="flex items-center gap-1">
                                <button
                                    data-magic-json-download
                                    onClick={handleDownloadJson}
                                    className="flex h-8 items-center gap-1.5 rounded-lg px-2.5 text-mr-caption text-neutral-400 hover:bg-white/5 hover:text-sky-300 transition-colors cursor-pointer"
                        ...
                        {/* terminal surface */}
                        <div className="relative mx-4 flex-1 overflow-hidden rounded-xl bg-desk ring-1 ring-mr-line-soft">
                        ...
                        <div className="flex justify-end px-6 py-4">
                            <button
                                onClick={closeJsonModal}
                                className="rounded-lg bg-mr-surface-soft px-4 py-2 text-sm font-medium text-neutral-200 ring-1 ring-white/[0.08] hover:bg-white/10 transition-colors cursor-pointer"
                            >
                                {t('common.done')}
                            </button>
                        </div>
