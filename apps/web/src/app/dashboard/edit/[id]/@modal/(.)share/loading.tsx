...
import { Loader2, Share2 } from '@magic-resume/icons';
...
export default function Loading() {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-100 flex items-center justify-center p-4 animate-in fade-in fill-mode-forwards duration-300 delay-200 opacity-0">
      <div className="w-full max-w-xl h-fit py-12 bg-desk border border-neutral-800 rounded-3xl shadow-[0_8px_28px_rgba(0,0,0,0.14)] flex flex-col items-center justify-center overflow-hidden">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center gap-2">
            <h2 className="text-xl font-bold text-white tracking-tight animate-pulse">
              {t('loading.share.title')}
            </h2>
            <p className="text-sm text-neutral-500">{t('loading.share.description')}</p>
          </div>
          <div className="mt-4">
