...
const ResumeMiniPreview = React.memo(({ template, className = "", sectionCount }: ResumeMiniPreviewProps) => {
  ...
  const SectionBlock = ({ titleWidth = '30%' }: { titleWidth?: string }) => (
    <div className="space-y-[3px]">
      ...
      <div className="h-0.5 rounded-sm w-full" style={{ backgroundColor: text25 }} />
      <div className="h-0.5 rounded-sm w-[90%]" style={{ backgroundColor: text25 }} />
      <div className="h-0.5 rounded-sm w-[75%]" style={{ backgroundColor: text25 }} />
      <div className="h-0.5 rounded-sm w-[85%]" style={{ backgroundColor: text25 }} />
    </div>
  );

  const SidebarSection = () => (
    <div className="space-y-[2px]">
      <div className="h-0.5 bg-white/40 rounded-sm w-3/5" />
      <div className="h-0.5 bg-white/20 rounded-sm w-full" />
      <div className="h-0.5 bg-white/20 rounded-sm w-4/5" />
      <div className="h-0.5 bg-white/20 rounded-sm w-3/5" />
    </div>
  );
        ...
        <div className="flex h-full">
          ...
          <div className="flex-1 p-2 space-y-2.5">
            <div className="space-y-1">
              ...
              <div className="h-0.5 rounded-sm w-full" style={{ backgroundColor: text40 }} />
              <div className="h-0.5 rounded-sm w-4/5" style={{ backgroundColor: text25 }} />
            </div>
        ...
        <div className="p-2.5 space-y-2 h-full">
          ...
          <div className="space-y-1 pb-1" style={{ borderBottom: `1px solid ${text25}` }}>
            ...
            <div className="flex gap-2">
              <div className="h-0.5 rounded-sm flex-1" style={{ backgroundColor: text40 }} />
              <div className="h-0.5 rounded-sm flex-1" style={{ backgroundColor: text40 }} />
              <div className="h-0.5 rounded-sm flex-1" style={{ backgroundColor: text40 }} />
            </div>
          </div>
