...
created: 2026-07-03
updated: 2026-07-03
summary: Setup, exposed MCP tools/resources/prompts, editing rules, and runtime boundary notes.
scope: [packages/mcp]
repos: [Magic-Resume]
...
```bash
npx -y @magic-resume/mcp config set --api-url "http://localhost:<port>/api" --pat "mr_pat_xxx"
```
